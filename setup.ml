...
(* OASIS_START *)
(* DO NOT EDIT (digest: e95d82abe0015a5070df0b0884fcddec) *)
(*
...
let setup_t =
  {
            ...
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$test_channel", []))];
            ...
            [
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "test_channel.ml"});
               Test
                 ({
                     cs_name = "test_channel";
                     cs_data = PropList.Data.create ();
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "5\189\016JS\026\240\129\127\020\1868\225\135q\212";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
