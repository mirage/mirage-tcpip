...
(* OASIS_START *)
(* DO NOT EDIT (digest: 3f68ef18c6fcc339226464f2173efca6) *)
(*
...
let setup_t =
  {
            ...
            [
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules =
                        ["Ethif"; "Ethif_wire"; "Ethif_parse"; "Ethif_print"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "tcpip";
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules =
                        ["Arpv4"; "Arpv4_wire"; "Arpv4_parse"; "Arpv4_print"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "tcpip";
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\237\137\151\006\151\189\182Y\178\180\185mN\205+Y";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
